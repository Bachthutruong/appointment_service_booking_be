...
exports.deleteAppointment = exports.updateAppointment = exports.createAppointment = exports.getAppointmentsCalendar = exports.getAppointment = exports.getAppointments = void 0;
...
// @access  Private
exports.getAppointments = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const { startDate, endDate, status, customerId, view = 'month', page = 1, limit = 50 } = req.query;
    let query = {};
    // Date range filter
    ...
    const total = await Appointment_1.Appointment.countDocuments(query);
    res.json({
        success: true,
        appointments,
        pagination: {
...
// @access  Private
exports.getAppointment = (0, errorHandler_1.asyncHandler)(async (req, res) => {
...
// @access  Private
exports.getAppointmentsCalendar = (0, errorHandler_1.asyncHandler)(async (req, res) => {
...
exports.createAppointment = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    const populatedAppointment = await Appointment_1.Appointment.findById(appointment._id)
        .populate('customer', 'name phone')
        .populate('service', 'name price duration')
        .populate('createdBy', 'name');
    res.status(201).json({
...
exports.updateAppointment = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    ...
    if (status === 'cancelled' && appointment.orderId) {
        await Order_1.Order.findByIdAndDelete(appointment.orderId);
    }
    const updatedAppointment = await Appointment_1.Appointment.findByIdAndUpdate(req.params.id, {
...
// @access  Private
exports.deleteAppointment = (0, errorHandler_1.asyncHandler)(async (req, res) => {
    const appointment = await Appointment_1.Appointment.findById(req.params.id);
    if (!appointment) {
        return res.status(404).json({ message: 'Appointment not found' });
    }
